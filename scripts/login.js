...
window.onload = async () => {
    ...
    const username_input = await getData("#login_username", 500, 3000)
    const username_send_btn = await getData("#login_password_continue", 500, 3000)
    ...
    const password_input = await getData("#login_password", 500, 3000)
    const login_btn = await getData("#login_control_continue", 500, 3000)
